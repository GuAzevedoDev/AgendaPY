...
# Bind interno — o proxy reverso é quem fica exposto na porta 80/443, o Gunicorn só
# precisa ser alcançável por ele (mesma rede docker ou localhost).
...
# O proxy reverso envia esses headers; sem isso request.is_secure e url_for(_external=True)
