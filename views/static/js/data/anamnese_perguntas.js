...
export const SECOES_CLIENTE = [
  ...
  },
  {
    ...
    perguntas: [
      ...
      { id: "alergia_especifique", label: "Se sim, especifique", tipo: "texto", dependeDe: "alergia", obrigatorio: true },
      ...
      { id: "problemas_pele_especifique", label: "Se sim, especifique", tipo: "texto", dependeDe: "problemas_pele", obrigatorio: true },
    ],
  },
  {
    id: "habitos_rotina",
    ...
    perguntas: [
      ...
      { id: "usa_filtro_solar", label: "Usa filtro solar?", tipo: "radio", opcoes: ["Sim", "Não"], obrigatorio: true },
      { id: "filtro_solar_qual", label: "Qual?", tipo: "texto", dependeDe: "usa_filtro_solar", obrigatorio: true },
